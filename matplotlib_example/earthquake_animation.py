...
def update_fig(i):
    ...
    sorted_df = current_df.sort_values(by='value', ascending=False).head(6)  # 取前6名
...
# 保存动画
anim.save(filename='video/earthquake_animation_with_top6_ranking.mp4', writer='ffmpeg')
